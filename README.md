About event-model-feedstock
===========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/event-model-feedstock/blob/main/LICENSE.txt)
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/event-model-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/event-model-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `event-model` can be installed with `conda`:
...
```
mamba install event-model
```

It is possible to list all of the versions of `event-model` available on your platform with `conda`:
...
```
mamba search event-model --channel conda-forge
```
...
mamba repoquery search event-model --channel conda-forge

# List packages depending on `event-model`:
mamba repoquery whoneeds event-model --channel conda-forge

# List dependencies of `event-model`:
mamba repoquery depends event-model --channel conda-forge
```
